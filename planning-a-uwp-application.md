...
UWP applications are made available through a trusted and curated experience of the [Microsoft Store][0]. The Microsoft Store provides an improved servicing model for users; applications are easily discoverable and kept up-to-date. Organizations can also choose to provide an internal channel for these applications through the Microsoft Store for Business and Microsoft Store for Education.
